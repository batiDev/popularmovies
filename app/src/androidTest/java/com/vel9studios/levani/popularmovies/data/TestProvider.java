...
public class TestProvider extends AndroidTestCase {
    ...
    public void testBasicWeatherQuery() {
        ...
        long weatherRowId = db.insert(MoviesEntry.TABLE_NAME, null, weatherValues);
    ...
    public void testInsertReadProvider() {
        ...
        Uri weatherInsertUri = mContext.getContentResolver()
                .insert(MoviesEntry.CONTENT_URI, weatherValues);
    ...
    public void testDeleteRecords() {
        ...
        mContext.getContentResolver().registerContentObserver(MoviesEntry.CONTENT_URI, true, movieObserver);
    ...
    public void testBulkInsert() {
        ...
        cursor = mContext.getContentResolver().query(
                ...
                null, // values for "where" clause
                null
               // MoviesEntry.COLUMN_DATE + " ASC"  // sort order == by DATE ASCENDING
        );
